package com.hexagonal.server.identity.infra.integration.test.flow.transaction;
...
import com.hexagonal.server.identity.infra.integration.test.common.constant.transaction.Endpoint;
import com.hexagonal.server.identity.infra.integration.test.common.mock.account.AccountMock;
import com.hexagonal.server.identity.infra.integration.test.common.mock.transaction.TransactionCreateRequestMock;
...
import static com.hexagonal.server.identity.core.model.enums.transaction.TransactionStatusEnum.COMPLETED;
import static com.hexagonal.server.identity.infra.integration.test.common.mock.transaction.TransactionUpdateRequestMock.generateTransactionUpdateRequest;
