package com.hexagonal.server.identity.infra.persistence.adapter.out.account.config;

import com.hexagonal.server.identity.core.port.out.account.AccountRepositoryPort;
import com.hexagonal.server.identity.infra.persistence.adapter.out.account.AccountJpaRepository;
import com.hexagonal.server.identity.infra.persistence.adapter.out.account.AccountRepositoryAdapter;
