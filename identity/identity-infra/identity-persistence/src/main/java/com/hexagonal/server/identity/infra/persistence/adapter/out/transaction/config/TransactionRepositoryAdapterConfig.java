package com.hexagonal.server.identity.infra.persistence.adapter.out.transaction.config;

import com.hexagonal.server.identity.core.port.out.transaction.TransactionRepositoryPort;
import com.hexagonal.server.identity.infra.persistence.adapter.out.transaction.TransactionJpaRepository;
import com.hexagonal.server.identity.infra.persistence.adapter.out.transaction.TransactionRepositoryAdapter;
