package com.hexagonal.server.identity.application.account.exception.elementnotfound;
...
import static com.hexagonal.server.identity.application.account.exception.utils.message.ErrorMessageConstant.ACCOUNT_NOT_FOUND_EXCEPTION;
